<%@ Page Title="" Language="C#" MasterPageFile="~/AdminZone/AdminPanel.Master" AutoEventWireup="true" CodeBehind="AdminIndex.aspx.cs" Inherits="HealthCare.AdminZone.AdminIndex" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="p-4">
        <%--Title--%>
        <h2 class="h2 d-none d-sm-block">Admin Dashboard</h2>
            ...
            <div class="col-xl-3 col-sm-6 py-2">
                <div class="card text-white bg-warning h-100">
                    <div class="card-body">
                        ...
                        <h6 class="text-uppercase">Online Consult</h6>
        ...
        <%--<div class="row placeholders mb-3">
                ...
                <p class="lead mt-5">Are you ready for Bootstap 4? It's the 4th generation of this popular responsive framework. Bootstrap 4 will include some interesting new features such as flexbox, 5 grid sizes (now including xl), cards, `em` sizing, CSS normalization (reboot) and larger font</p>
                <div class="row my-4">
                ...
                <div class="card-columns mb-3">
                            ...
                            <div class="card card-body">
                                <blockquote class="card-blockquote">
                                    ...
                                    <footer>
                                        <small class="text-muted">Someone famous like <cite title="Source Title">Mark Otto</cite>
                                        </small>
                                    </footer>
                                </blockquote>
                            </div>
                            ...
                            <div class="card card-body text-right">
                                <blockquote class="card-blockquote">
                                    ...
                                    <footer>
                                        <small class="text-muted">Someone famous in <cite title="Source Title">Bootstrap</cite>
                                        </small>
                                    </footer>
                                </blockquote>
                            </div>
                                    ...
                                    <div id="tabsJustifiedContent" class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-5">
                                                    <img src="//placehold.it/170" class="float-right img-responsive img-rounded">
                                                </div>
                                            </div>
                                            <hr>
    ...
    <div class="row p-4 bg-white">
        <div class="col-lg-3 col-sm-6 py-2">
            <div class="card-box bg-blue">
                <div class="inner">
                    <i class="fa fa-user-circle-o fa-3x mb-3"></i>
                    <h5>Registartion<br />Management</h5>
                </div>
                 <div class="icon">
                    <i class="fa fa-users" aria-hidden="true"></i>
                </div>
                <a href="RegistrationManagement.aspx" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6 py-2">
            <div class="card-box bg-green">
                <div class="inner">
                    <i class="fa fa-user-circle-o fa-3x mb-3"></i>
                    <h5>Appointment<br />Management</h5>
                </div>
                <div class="icon">
                    <i class="fa fa-money" aria-hidden="true"></i>
                </div>
                <a href="AppointmentManagement.aspx" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6 py-2">
            <div class="card-box bg-orange">
                <div class="inner">
                    <i class="fa fa-user-circle-o fa-3x mb-3"></i>
                    <h5>Enquiry<br />Management</h5>
                </div>
                <div class="icon">
                    <i class="fa fa-user-plus" aria-hidden="true"></i>
                </div>
                <a href="EnquiryManagement.aspx" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-sm-6 py-2">
            <div class="card-box bg-red">
                <div class="inner">
                    <i class="fa fa-user-circle-o fa-3x mb-3"></i>
                    <h5>Login<br />Management</h5>
                </div>
                <div class="icon">
                    <i class="fa fa-users" aria-hidden="true"></i>
                </div>
                <a href="LoginManagement.aspx" class="card-box-footer">View More <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
    </div>
</asp:Content>
