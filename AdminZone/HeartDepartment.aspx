<%@ Page Title="" Language="C#" MasterPageFile="~/AdminZone/AdminPanel.Master" AutoEventWireup="true" CodeBehind="HeartDepartment.aspx.cs" Inherits="HealthCare.AdminZone.HeartDepartment" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="p-4">
        <%--Title--%>
        <h2 class="h2 d-none d-sm-block">Heart Department Dashboard</h2>
            ...
            <div class="table-responsive">
                <asp:GridView ID="GridView1" CssClass="w-100" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="15" DataKeyNames="SerialNo" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="Horizontal">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="HADT" HeaderText="HADT" SortExpression="HADT" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HealthcareConnectionString %>" SelectCommand="SELECT * FROM [HeartDepartment]"></asp:SqlDataSource>
            </div>
        </div>
    </div>
</asp:Content>
