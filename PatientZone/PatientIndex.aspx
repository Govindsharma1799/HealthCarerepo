<%@ Page Title="" Language="C#" MasterPageFile="~/PatientZone/PatientZone.Master" AutoEventWireup="true" CodeBehind="PatientIndex.aspx.cs" Inherits="HealthCare.PatientZone.PatientIndex" %>
    ...
    <section id="services" class="services bg-light">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-4 icon-box">
                    <div class="icon"><i class="fa fa-lungs"></i></div>
